...
class Exception(object):
    ...
    def __init__(self, msg):
        _loci.Exception_swiginit(self, _loci.new_Exception(msg))
...
class StopIteration(Exception):
    ...
    def __init__(self, msg):
        _loci.StopIteration_swiginit(self, _loci.new_StopIteration(msg))
...
class IndexError(Exception):
    ...
    def __init__(self, msg):
        _loci.IndexError_swiginit(self, _loci.new_IndexError(msg))
...
class ValueError(Exception):
    ...
    def __init__(self, msg):
        _loci.ValueError_swiginit(self, _loci.new_ValueError(msg))
...
class SystemError(Exception):
    ...
    def __init__(self, msg):
        _loci.SystemError_swiginit(self, _loci.new_SystemError(msg))
...
class RuntimeError(Exception):
    ...
    def __init__(self, msg):
        _loci.RuntimeError_swiginit(self, _loci.new_RuntimeError(msg))
...
class GenotypeSampler(LociUpdater):
    ...
    def __init__(self, pool):
        _loci.GenotypeSampler_swiginit(self, _loci.new_GenotypeSampler(pool))
...
class PARModel(LociUpdater):
    ...
    def __init__(self, pars, isVariable):
        _loci.PARModel_swiginit(self, _loci.new_PARModel(pars, isVariable))
...
class PARGFUpdater(LociUpdater):
    ...
    def __init__(self, phenotype):
        _loci.PARGFUpdater_swiginit(self, _loci.new_PARGFUpdater(phenotype))
...
class ORModel(LociUpdater):
    ...
    def __init__(self, oddsRatios):
        _loci.ORModel_swiginit(self, _loci.new_ORModel(oddsRatios))
...
class ORGFUpdater(LociUpdater):
    ...
    def __init__(self, phenotype, baseline_penetrance):
        _loci.ORGFUpdater_swiginit(self, _loci.new_ORGFUpdater(phenotype, baseline_penetrance))
...
class DiseaseEffectGenerator(LociUpdater):
    ...
    def __init__(self, baseline_penetrance):
        _loci.DiseaseEffectGenerator_swiginit(self, _loci.new_DiseaseEffectGenerator(baseline_penetrance))
...
class MeanShiftModel(LociUpdater):
    ...
    def __init__(self, meanShifts):
        _loci.MeanShiftModel_swiginit(self, _loci.new_MeanShiftModel(meanShifts))
...
def generate_disease_by_OR(labels, counts, dat, ors, bp, haplopool, collapse_rare=1.0):
    return _loci.generate_disease_by_OR(labels, counts, dat, ors, bp, haplopool, collapse_rare)
generate_disease_by_OR = _loci.generate_disease_by_OR

def generate_disease_by_PAR_OR(labels, counts, dat, par, par_const, bp, haplopool, collapse_rare=1.0):
    return _loci.generate_disease_by_PAR_OR(labels, counts, dat, par, par_const, bp, haplopool, collapse_rare)
generate_disease_by_PAR_OR = _loci.generate_disease_by_PAR_OR

def generate_qt(size, dat, qtcoefs, haplopool, collapse_rare=1.0):
    return _loci.generate_qt(size, dat, qtcoefs, haplopool, collapse_rare)
generate_qt = _loci.generate_qt

def generate_qt_extremes_infinite(nupper, nlower, dat, qtcoefs, cupper, clower, labels, haplopool, collapse_rare=1.0):
    return _loci.generate_qt_extremes_infinite(nupper, nlower, dat, qtcoefs, cupper, clower, labels, haplopool, collapse_rare)
generate_qt_extremes_infinite = _loci.generate_qt_extremes_infinite

def generate_qt_extremes_finite(size, dat, qtcoefs, qupper, qlower, labels, haplopool, collapse_rare=1.0):
    return _loci.generate_qt_extremes_finite(size, dat, qtcoefs, qupper, qlower, labels, haplopool, collapse_rare)
